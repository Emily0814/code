...
public class Ex45 { //이건 꼭 주말에 복습!! 7/5
	...
	public static void main(String[] args) {
		...
		//결론]
		//- 보통 형제 클래스 > 부모 배열 > 한번에 관리
		//- 가끔씩, 자식 클래스 구현 기능 접근 > 다운 캐스팅 > 고유 기능 가능
	...
	private static void m4() {
		...
		list[0] = new LG100();	//p3
		list[1] = new HP200();	//p4	//형변환 때문에 가능
...
//			System.out.println(객체  instanceof  클래스); 새로운 
	...
	private static void m2() {
		...
		//Case 2. 전용
		//- 배열 사용
		LG100[] lg = new LG100[5];	//객체가 아닌 배열 생성
...
//	private int price;
	...
	public void print() {
		...
		System.out.println("LG 기술 사용 > 출력"); //사용법 동일 
