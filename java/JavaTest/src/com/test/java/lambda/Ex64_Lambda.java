...
public class Ex64_Lambda {
	...
	public static void main(String[] args) {
		...
		/*
			...
			1. Consumer
				...
				- BiConsumer<T,U>
				- ..
				- 매개변수O, 반환값X > 추상 메서드 제공한다.
			
			2. Supplier
				- Supplier<T>
				- ..
				- 매개변수X, 반환값O > 추상 메서드 제공한다.
				
			3. Function
				- Function<T,R>
				- BiFunction<T,U,R>
				- ..
				- 매개변수O, 반환값O > 추상 메서드 제공한다.
	...
	private static void m3() {
		...
		BiFunction<Integer, Integer, String> f3  ////맨 끝이 리턴값, 나머지 매개변수
		= (a, b) -> {
	...
	private static void m1() {
		...
		MyConsumer m1 = num -> System.out.println(num); //인터페이스 선언하고 람다식
		m1.test(100);
		m1.test(200);
		
		
		//java.util.function
		Consumer<Integer> c1 = num -> System.out.println(num); //java.util.function에서 제공
		c1.accept(100);
		c1.accept(200);
