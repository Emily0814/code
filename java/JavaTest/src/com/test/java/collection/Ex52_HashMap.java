...
public class Ex52_HashMap {
	...
	public static void main(String[] args) {
		...
		System.out.println(map.get("blue"));	//map에서 없는 방에 이름은 null이라고 나옴
		
		//4.요소 수정
		//- key: 식별자(수정 불가)
		//- value: 값(수정 가능)
		map.put("yellow", "옐로우");	//추가하기와 수정은 method가 동일
		...
		System.out.println(map.containsKey("빨강"));
	...
	private static void m2() {
		...
		map1.put("방이름", 100);	//HashMap key값이 거의 String이다. 왜냐? 외에는 쓸모가 없다.
	...
	private static void m1() {
		...
		System.out.println( s1[0] + s1[1] + s1[2] );	//어떤 것이 어떤 과목이 알 수 없음
		...
		System.out.println(s2.get(0) + s2.get(1) + s2.get(2));	//과목 갯수 불확실
		...
		System.out.println(s4.get("math"));	//과목이름을 확실하게 알 수 있으면서 편리함, Class와 비슷
