...
public class Ex01 {
	...
	public static void main(String[] args) {
		...
		/*
			...
			1. JDBC > 우리 수업 중에 배우는데 밖에서 배웠다고 말하면 무시한다고 하나 기죽지말라고 하심
			1.5. ..
			2. Spring-JDBC
			3. MyBatis
			4. JPA
			...
			3. 질의
				- SQL 사용
				3.1 반환값이 없는 쿼리
					- select를 제외한 쿼리(insert, delete, create 등..)
			...
			- java.net.UnknownHostException: 알려진 호스트가 없습니다 (localhost0)
...
ORA-12505, TNS:listener does not currently know of SID given in connect descriptor
			...
			5. 드라이버 로딩 X
			- oracle.jdbc.driver.OracleDrivers > 이 부분이 틀렸다고 보여줌
...
ORA-12505, TNS:listener does not currently know of SID given in connect descriptor
		...
		*/
		...
		Connection conn = null; //import 알아두기
