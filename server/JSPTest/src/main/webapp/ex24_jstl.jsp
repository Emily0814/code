...
<body>
	...
	<% 
		...
		int a = 10; //지역 변수
		pageContext.setAttribute("b", 20); //변수는 아니지만 편의상  pageContext 변수라고 부름
	...
	-->
	<%-- <c:set var="c" value="30"></c:set> --%> <!-- core라는 뜻으로 c를 주로 사용, namespace -->
	<c:set var="c" value="30"/> <!-- /를 붙여서 단독태그로 사용가능 -->
	...
	<!-- ******** 내장 객체의 값을 꺼낼 때는 반드시  EL 사용한다. -->
	<c:if test="${num > 0}"> <%-- <c:if test="조건"> --%>
		<div>${num}은 양수입니다.</div>
	</c:if>
	<c:if test="${num <= 0}">
