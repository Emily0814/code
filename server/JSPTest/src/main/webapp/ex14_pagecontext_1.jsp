...
<% 
	...
	*/
	...
	//pageContext.forward("ex14_pagecontext_2.jsp"); /* 아래 코드?보다는 이것을 많이 사용함 */
...
<body>
	...
	<form method="POST" action="ex14_pagecontext_2.jsp">
	...
	<script>
	document.getElentByID('link1').onclick = function() {
