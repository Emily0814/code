...
public class BoardDAO {
	...
	public void delCommentAll(String seq) { //왜 안되냐...
	...
	public int checkDel(HashMap<String, Integer> map) {
		...
		try {
			...
			String sql = "select * from tblBoard where thread < ? and thread > (select nvl(max(thread), ?) from tblBoard where thread < ? and depth = ?);";
